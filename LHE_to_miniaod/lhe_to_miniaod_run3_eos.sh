...
lhe_file=root://cms-xrd-global.cern.ch//store/user/mcitron/ppTohToSS1SS2_SS1Tobb_SS2Tobb_ggh_withISR/unweighted_events_mh${MH}_mx${MX}_pl${PL}_ev100000.lhe
...
#ROOT_DIR=root://cms-xrd-global.cern.ch//store/group/dpg_hcal/comm_hcal/gillian/LLP_Run3/mh${MH}_mx${MX}_pl${PL}_ev${N_EV}/
ROOT_DIR=/eos/cms/store/group/dpg_hcal/comm_hcal/gillian/LLP_Run3/mh${MH}_mx${MX}_pl${PL}_ev${N_EV}/
