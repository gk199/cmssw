...
Done on lxplus in
```
/afs/cern.ch/work/g/gkopp/L1emulator/CMSSW_12_3_X_2022-01-13-2300/src
```
...
## Running
```
cd CMSSW_12_3_X_2022-01-13-2300/src
...
```
Edit `my_cmssw_release=CMSSW_12_3_X_2022-01-13-2300`, `new_code_dir=/afs/cern.ch/work/g/gkopp/L1emulator` (this is the directory in which the archive file was untarred, and it has the modified files needed for the uGT emulator).
...
Following the L1 (uHTR, Layer-1, Layer-2) emulator, I used the output file of this `file:/afs/cern.ch/work/g/gkopp/L1emulator/CMSSW_12_3_X_2022-01-13-2300/src/HTo2LongLivedTo4b_MH-125_MFF-50_CTau-3000mm_TuneCP5_13TeV_pythia8_cff-digi_noPU.root` as the input to `runGlobalFakeInputProducer.py`. Edits:
```
nevents = 10 # line 17
"file:/afs/cern.ch/work/g/gkopp/L1emulator/CMSSW_12_3_X_2022-01-13-2300/src/HTo2LongLivedTo4b_MH-125_MFF-50_CTau-3000mm_TuneCP5_13TeV_pythia8_cff-digi_noPU.root" # line 82
```
